...
const Contact = () => {
  ...
  return (
    <div className="relative bg-black h-screen overflow-hidden flex flex-col md:flex-row">
      ...
      {/* Left Side Image */}
      <div className="flex-shrink-0 w-full md:w-1/2 relative z-10 flex flex-col items-center justify-center p-8">
        <img 
          src="cheers.png" // Replace with your image URL
          alt="Chat"
          className="w-48 h-48 rounded-lg shadow-lg"
        />
        <h2 className="text-3xl md:text-4xl font-bold text-gold mb-4 text-center">Let's raise a glass together!</h2>
      </div>

      {/* Contact Form Section */}
      <div className="relative z-10 flex items-center justify-center h-full p-8 w-full md:w-1/2">
        <div className="p-8 rounded-lg shadow-lg w-full max-w-md">
          <h1 className="mb-8 text-4xl md:text-5xl font-bold relative text-transparent bg-clip-text" style={{
